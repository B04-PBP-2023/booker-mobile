...
List<BoughtBook> boughtBookFromJson(String str) => List<BoughtBook>.from(json.decode(str).map((x) => BoughtBook.fromJson(x)));

String boughtBookToJson(List<BoughtBook> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
